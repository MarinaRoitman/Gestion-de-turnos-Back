...
public interface ProfesionalService {
    ...
    public Profesional createProfesional(String nombre, String apellido, String mail, String matricula, String direccion, byte[] foto) throws ProfesionalExistenteException;

    public Profesional modifyProfesional(Long id, String nombre, String apellido, String mail, String matricula, String direccion, byte[] foto) throws ProfesionalInexistenteException;
